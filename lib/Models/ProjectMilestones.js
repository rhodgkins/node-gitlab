(function() {
  ...
  ProjectMilestones = (function(superClass) {
    ...
    ProjectMilestones.prototype.all = function(projectId, fn) {
      ...
      return Utils.multiPageHandler(params, fn, (function(_this) {
        return function(nextParams, cb) {
          ...
          return _this.get("projects/" + (Utils.parseProjectId(projectId)) + "/milestones", nextParams, cb);
        };
      })(this));
    };
    ...
    ProjectMilestones.prototype.show = function(projectId, milestoneId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/milestones/" + (parseInt(milestoneId)), fn);
    };
    ...
    ProjectMilestones.prototype.add = function(projectId, title, description, due_date, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/milestones", params, fn);
    };
    ...
    ProjectMilestones.prototype.update = function(projectId, milestoneId, title, description, due_date, state_event, fn) {
      ...
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/milestones/" + (parseInt(milestoneId)), params, fn);
    };
