(function() {
  ...
  ProjectMergeRequests = (function(superClass) {
    ...
    ProjectMergeRequests.prototype.list = function(projectId, params, fn) {
      ...
      return Utils.multiPageHandler(params, fn, (function(_this) {
        return function(nextParams, cb) {
          _this.debug("Recurse Projects::mergerequests()");
          return _this.get("projects/" + (Utils.parseProjectId(projectId)) + "/merge_requests", nextParams, cb);
        };
      })(this));
    };
    ...
    ProjectMergeRequests.prototype.show = function(projectId, mergerequestId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/merge_request/" + (parseInt(mergerequestId)), fn);
    };
    ...
    ProjectMergeRequests.prototype.add = function(projectId, sourceBranch, targetBranch, assigneeId, title, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/merge_requests", params, fn);
    };
    ...
    ProjectMergeRequests.prototype.update = function(projectId, mergerequestId, params, fn) {
      ...
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/merge_request/" + (parseInt(mergerequestId)), params, fn);
    };
    ...
    ProjectMergeRequests.prototype.comment = function(projectId, mergerequestId, note, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/merge_request/" + (parseInt(mergerequestId)) + "/comments", params, fn);
    };
