(function() {
  ...
  Groups = (function(superClass) {
    ...
    Groups.prototype.all = function(params, fn) {
      ...
      return Utils.multiPageHandler(params, fn, (function(_this) {
        return function(nextParams, cb) {
          ...
          return _this.get("groups", nextParams, cb);
        };
      })(this));
    };
    ...
    Groups.prototype.show = function(groupId, fn) {
      ...
      return this.get("groups/" + (parseInt(groupId)), fn);
    };
    ...
    Groups.prototype.listMembers = function(groupId, fn) {
      ...
      return this.get("groups/" + (parseInt(groupId)) + "/members", fn);
    };
    ...
    Groups.prototype.addMember = function(groupId, userId, accessLevel, fn) {
      ...
      return this.post("groups/" + (parseInt(groupId)) + "/members", params, fn);
    };
    ...
    Groups.prototype.create = function(params, fn) {
      ...
      return this.post("groups", params, fn);
    };
    ...
    Groups.prototype.addProject = function(groupId, projectId, fn) {
      ...
      return this.post("groups/" + (parseInt(groupId)) + "/projects/" + (parseInt(projectId)), null, fn);
    };
    ...
    Groups.prototype.search = function(nameOrPath, fn) {
      ...
      return this.get("groups", params, fn);
    };
