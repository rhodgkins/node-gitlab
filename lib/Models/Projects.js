(function() {
  ...
  Projects = (function(superClass) {
    ...
    Projects.prototype.all = function(params, fn) {
      ...
      return Utils.multiPageHandler(params, fn, (function(_this) {
        return function(nextParams, cb) {
          ...
          return _this.get("projects", nextParams, cb);
        };
      })(this));
    };
    ...
    Projects.prototype.show = function(projectId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)), fn);
    };
    ...
    Projects.prototype.create = function(params, fn) {
      ...
      return this.post("projects", params, fn);
    };
    ...
    Projects.prototype.create_for_user = function(params, fn) {
      ...
      return this.post("projects/user/" + params.user_id, params, fn);
    };
    ...
    Projects.prototype.edit = function(projectId, params, fn) {
      ...
      return this.put("projects/" + (Utils.parseProjectId(projectId)), params, fn);
    };
    ...
    Projects.prototype.addMember = function(params, fn) {
      ...
      return this.post("projects/" + params.id + "/members", params, fn);
    };
    ...
    Projects.prototype.editMember = function(params, fn) {
      ...
      return this.put("projects/" + params.id + "/members/" + params.user_id, params, fn);
    };
    ...
    Projects.prototype.listMembers = function(params, fn) {
      ...
      return this.get("projects/" + params.id + "/members", fn);
    };
    ...
    Projects.prototype.listCommits = function(params, fn) {
      ...
      return this.get("projects/" + params.id + "/repository/commits", params, fn);
    };
    ...
    Projects.prototype.listTags = function(params, fn) {
      ...
      return this.get("projects/" + params.id + "/repository/tags", fn);
    };
    ...
    Projects.prototype.remove = function(projectId, fn) {
      ...
      return this["delete"]("projects/" + (Utils.parseProjectId(projectId)), fn);
    };
    ...
    Projects.prototype.fork = function(params, fn) {
      ...
      return this.post("projects/fork/" + params.id, params, fn);
    };
    ...
    Projects.prototype.search = function(projectName, params, fn) {
      ...
      return this.get("projects/search/" + projectName, params, fn);
    };
