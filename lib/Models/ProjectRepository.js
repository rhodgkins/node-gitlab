(function() {
  ...
  ProjectRepository = (function(superClass) {
    ...
    ProjectRepository.prototype.diffCommit = function(projectId, sha, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/repository/commits/" + sha + "/diff", fn);
    };
    ...
    ProjectRepository.prototype.showFile = function(projectId, params, fn) {
      ...
      if (params.file_path && params.ref) {
        ...
        return this.get(("projects/" + (Utils.parseProjectId(params.projectId)) + "/repository/raw_blobs/") + params.file_id, params, fn);
      }
    };
