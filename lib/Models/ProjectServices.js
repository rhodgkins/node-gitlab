(function() {
  ...
  ProjectServices = (function(superClass) {
    ...
    ProjectServices.prototype.show = function(projectId, serviceName, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/services/" + serviceName, fn);
    };
    ...
    ProjectServices.prototype.update = function(projectId, serviceName, params, fn) {
      ...
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/services/" + serviceName, params, fn);
    };
    ...
    ProjectServices.prototype.remove = function(projectId, serviceName, fn) {
      ...
      return this["delete"]("projects/" + (Utils.parseProjectId(projectId)) + "/services/" + serviceName, fn);
    };
